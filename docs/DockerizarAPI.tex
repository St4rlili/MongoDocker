...
\begin{itemize}
    ...
    \item Una API que se conecte a dicha base de datos
\end{itemize}
...
\begin{lstlisting}[caption=Log para mostrar información]
...
Para hacer esto, primero iremos a un servidor nuestro y accederemos a su configuración, luego iremos a la sección de \textbf{Integraciones}.

\vspace{0.5cm}

\begin{center}
    \includegraphics[width=0.8\textwidth]{../images/webhook.png}
\end{center}

\vspace{0.5cm}

Aquí crearemos un nuevo \textbf{Webhook}, donde le daremos un nombre y el canal donde queremos que se envíe el mensaje.

\vspace{0.5cm}

\begin{center}
    \includegraphics[width=0.8\textwidth]{../images/webhook_creado.png}
\end{center}

\vspace{0.5cm}

Ahora copiaremos la URL del webhook que no da y la guardaremos en los secrets de GitHub con el nombre \textbf{DISCORD\_WEBHOOK}.

\vspace{0.5cm}

\begin{center}
    \includegraphics[width=0.8\textwidth]{../images/secrets.png}
\end{center}
...
\begin{lstlisting}[caption=Step para enviar mensaje a Discord]
      - name: Discord Webhook
        run: |
          curl -H "Content-Type: application/json" \
          -d "{\"content\": \"Imagen Docker actualizada y subida correctamente a Docker Hub!\"}" \
...
\begin{center}
    \includegraphics[width=0.8\textwidth]{../images/mensaje.png}
\end{center}
